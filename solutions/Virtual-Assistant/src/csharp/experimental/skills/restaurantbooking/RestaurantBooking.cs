...
namespace RestaurantBooking
{
    ...
    public class RestaurantBooking : IBot
    {
        ...
        public RestaurantBooking(ISkillConfiguration services, ConversationState conversationState, UserState userState, ServiceManager serviceManager = null, bool skillMode = false)
        {
