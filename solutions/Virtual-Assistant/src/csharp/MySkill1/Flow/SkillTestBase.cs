...
using MySkill1.Tests.Flow.LuisTestUtils;
using System.Collections.Generic;
using System.Threading;
using TestFramework;
using MySkill1.ServiceClients;
...
namespace MySkill1.Tests.Flow
{
    public class SkillTestBase : BotTestBase
    {
        ...
        {
            return new MySkill1.MySkill1(Services, ConversationState, UserState, TelemetryClient, null, true);
        }
    }
}
