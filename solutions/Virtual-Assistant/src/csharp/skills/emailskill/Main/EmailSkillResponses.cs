...
{
    public class EmailSkillResponses : TemplateManager
    {
        public const string Intro = "EmailSkill.Intro";
        public const string Help = "EmailSkill.Help";
        public const string Greeting = "EmailSkill.Greeting";
        public const string Confused = "EmailSkill.Confused";
        public const string Cancelled = "EmailSkill.Cancelled";
        ...
        private static IMessageActivity SendIntroCard(ITurnContext turnContext, dynamic data)
        {
            ...
            var introCard = File.ReadAllText(@".\EmailSkill\Resources\Intro.json");
