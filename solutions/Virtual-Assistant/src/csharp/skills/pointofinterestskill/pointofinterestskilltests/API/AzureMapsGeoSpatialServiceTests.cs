...
namespace PointOfInterestSkillTests.API
{
    ...
    public class AzureMapsGeoSpatialServiceTests
    {
        ...
        public async Task GetPointOfInterestDetailsTest()
        {
            ...
            Assert.AreEqual(pointOfInterest.PointOfInterestImageUrl, string.Format("https://atlas.microsoft.com/map/static/png?api-version=1.0&layer=basic&style=main&zoom={2}&center={1},{0}&width=512&height=512&subscription-key={3}", pointOfInterestList[0].Geolocation.Latitude, pointOfInterestList[0].Geolocation.Longitude, 15, MockData.Key));
        }
