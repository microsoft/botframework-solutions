...
namespace TestSkill1
{
    ...
    public class TestSkill1 : IBot
    {
        ...
        public TestSkill1(SkillConfigurationBase services, ConversationState conversationState, UserState userState, IBotTelemetryClient telemetryClient, ServiceManager serviceManager = null, bool skillMode = false)
        {
