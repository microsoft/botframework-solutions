...
namespace EmailSkill
{
    public class EmailSkillDialog : ComponentDialog
    {
        ...
        protected override async Task<DialogTurnResult> OnContinueDialogAsync(DialogContext dc, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await DigestEmailLuisResult(dc.Context, state.LuisResult);
        ...
        public async Task<DialogTurnResult> PromptUpdateMessage(WaterfallStepContext sc, CancellationToken cancellationToken = default(CancellationToken))
        {
            try
            {
                ...
                Action.Prompt,
                new PromptOptions() { Prompt = sc.Context.Activity.CreateReply(SharedResponses.NoFocusMessage, _responseBuilder), });
            }
            catch
            {
                await HandleDialogExceptions(sc);
        ...
        public async Task<DialogTurnResult> ConfirmBeforeSending(WaterfallStepContext sc, CancellationToken cancellationToken = default(CancellationToken))
        {
            try
            {
                ...
                var replyMessage = sc.Context.Activity.CreateAdaptiveCardReply(SharedResponses.ConfirmSend, "Dialogs/Shared/Resources/Cards/EmailWithOutButtonCard.json", emailCard, _responseBuilder);

                return await sc.PromptAsync(Action.TakeFurtherAction, new PromptOptions { Prompt = replyMessage, RetryPrompt = sc.Context.Activity.CreateReply(SharedResponses.ConfirmSendFailed, _responseBuilder), });
            }
            catch
            {
                await HandleDialogExceptions(sc);
        ...
        public async Task<DialogTurnResult> CollectAdditionalText(WaterfallStepContext sc, CancellationToken cancellationToken = default(CancellationToken))
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(state.Content))
                {
                    var noEmailContentMessage = sc.Context.Activity.CreateReply(SharedResponses.NoEmailContent, _responseBuilder);
                    if (sc.ActiveDialog.Id == nameof(ForwardEmailDialog))
                    {
                        var recipientConfirmedMessage =
                            sc.Context.Activity.CreateReply(SharedResponses.RecipientConfirmed, null, new StringDictionary() { { "UserName", await GetNameListString(sc) } });
        ...
        public async Task<DialogTurnResult> CollectNameList(WaterfallStepContext sc, CancellationToken cancellationToken = default(CancellationToken))
        {
            try
            {
                ...
                {
                    return await sc.PromptAsync(Action.Prompt, new PromptOptions { Prompt = sc.Context.Activity.CreateReply(SharedResponses.NoRecipients, _responseBuilder), });
                }
                else
                {
                    return await sc.NextAsync();
        ...
        public async Task<DialogTurnResult> ShowEmails(WaterfallStepContext sc, CancellationToken cancellationToken = default(CancellationToken))
        {
            try
            {
                ...
                {
                    await sc.Context.SendActivityAsync(sc.Context.Activity.CreateReply(SharedResponses.EmailNotFound, _responseBuilder));
                }
        ...
        public async Task ShowMailList(WaterfallStepContext sc, List<Message> messages)
        {
            ...
            var reply = sc.Context.Activity.CreateAdaptiveCardGroupReply(SharedResponses.ShowEmailPrompt, "Dialogs/Shared/Resources/Cards/EmailCard.json", AttachmentLayoutTypes.Carousel, cardsData, _responseBuilder, new StringDictionary { { "SearchType", searchType } });
        ...
        public async Task DigestEmailLuisResult(ITurnContext context, Email luisResult)
        {
            try
            {
                var state = await _emailStateAccessor.GetAsync(context);
        ...
        {
            await sc.Context.SendActivityAsync(sc.Context.Activity.CreateReply(SharedResponses.EmailErrorMessage, null));
