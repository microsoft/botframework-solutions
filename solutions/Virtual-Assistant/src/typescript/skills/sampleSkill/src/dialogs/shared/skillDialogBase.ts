...
import { sampleLU } from './resources/sampleLU';
...
export class SkillDialogBase extends ComponentDialog {
    ...
    protected conversationStateAccessor: StatePropertyAccessor<ISampleSkillConversationState>;
    protected userStateAccessor: StatePropertyAccessor<ISampleSkillUserState>;
    ...
    constructor(
        ...
        conversationStateAccessor: StatePropertyAccessor<ISampleSkillConversationState>,
        userStateAccessor: StatePropertyAccessor<ISampleSkillUserState>,
