...
{
    /// <summary>
    /// PointOfInterestSkillView.
    /// </summary>
    public class PointOfInterestSkillView : TemplateManager
    {
        /// <summary>
        /// INTRO.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PointOfInterestSkill"/> class.
        /// </summary>
        ...
        public static IMessageActivity Intro(ITurnContext turnContext, dynamic data)
        {
            ...
            var introCard = File.ReadAllText(@".\Dialogs\SharedResources\Intro.json");
