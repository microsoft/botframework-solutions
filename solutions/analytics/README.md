...
## Telemetry Logging
[Telemetry Overview](docs/analytics-telemetrylogging) highlights the provided telemetry for bot and user activities, including [LUIS](https://www.luis.ai/) and [QnA Maker](https://www.qnamaker.ai/) results.  how to configure your bot's telemetry, either through bot configuring or overriding the telemetry client.
...
The [Power BI Analytics sample](docs/analytics-powerbi) shows example Power BI dashboards to gain insights on your bot's performance and quality.