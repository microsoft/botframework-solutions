...
import io.swagger.client.model.TokenParameters;
...
public class TokensApi {
     ...
     */
    public com.squareup.okhttp.Call tokensGenerateTokenForNewConversationCall(TokenParameters tokenParameters, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call tokensGenerateTokenForNewConversationValidateBeforeCall(TokenParameters tokenParameters, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Conversation> tokensGenerateTokenForNewConversationWithHttpInfo(TokenParameters tokenParameters) throws ApiException {
        com.squareup.okhttp.Call call = tokensGenerateTokenForNewConversationValidateBeforeCall(tokenParameters, null, null);
    ...
    public com.squareup.okhttp.Call tokensGenerateTokenForNewConversationAsync(TokenParameters tokenParameters, final ApiCallback<Conversation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = tokensGenerateTokenForNewConversationValidateBeforeCall(tokenParameters, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call tokensRefreshTokenCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call tokensRefreshTokenValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Conversation> tokensRefreshTokenWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = tokensRefreshTokenValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call tokensRefreshTokenAsync(final ApiCallback<Conversation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = tokensRefreshTokenValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
