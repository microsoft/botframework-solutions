...
namespace SkillSample.Models
{
    ...
    public class EventActivityPrompt : ActivityPrompt
    {
        ...
        public async Task OnPromptNullContextAsync(object options, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public async Task OnPromptNullOptionsAsync(DialogContext dc, CancellationToken cancellationToken = default(CancellationToken))
        {
            // should throw ArgumentNullException
