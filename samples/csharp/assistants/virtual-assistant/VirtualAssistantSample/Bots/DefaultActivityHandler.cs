        ...
        where T : Dialog
    {
        ...
        protected override async Task OnMembersAddedAsync(IList<ChannelAccount> membersAdded, ITurnContext<IConversationUpdateActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            if (string.IsNullOrEmpty(userProfile.Name))
            {
                ...
                await turnContext.SendActivityAsync(_lgFileManager.GenerateActivityForLocale("NewUserIntroCard", userProfile));
            }
            else
            {
                // Send returning user intro card.
                await turnContext.SendActivityAsync(_lgFileManager.GenerateActivityForLocale("ReturningUserIntroCard", userProfile));
            }
