...
using AdaptiveCalendarSkill.Responses.Main;
using AdaptiveCalendarSkill.Responses.Sample;
using AdaptiveCalendarSkill.Responses.Shared;
using AdaptiveCalendarSkill.Services;
using AdaptiveCalendarSkill.Tests.Utilities;
                ...
                {
                    {
                        "en", new CognitiveModelSet
                        {
                            LuisServices = new Dictionary<string, ITelemetryRecognizer>
                            {
                                ...
                                { "AdaptiveCalendarSkill", SkillTestUtil.CreateRecognizer() }
                            }
                        }
                    }
                }
