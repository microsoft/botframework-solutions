...
program
    ...
    .option('--dispatchName [name]', '[OPTIONAL] Name of your assistant\'s \'.dispatch\' file')
    ...
    .option('--skillsFile [path]', '[OPTIONAL] Path to assistant Skills configuration file')
    .option('--resourceGroup [path]', '[OPTIONAL] Path to assistant Skills configuration file')
    .option('--appSettingsFile [path]', '[OPTIONAL] Path to assistant Skills configuration file')
    .option('--cognitiveModelsFile [path]', '[OPTIONAL] Path to assistant Skills configuration file')
