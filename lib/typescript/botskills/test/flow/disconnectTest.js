...
describe("The disconnect command", function () {
    ...
    beforeEach(function () {
        ...
        trainSkillStub = sandbox.stub(disconnector.trainSkill, "trainSkill");
        trainSkillStub.returns(Promise.resolve('Mocked function successfully'));
	...
	describe("should show an error", function () {
        ...
        it("when the trainSkill fails", async function () {
            const config = {
            ...
            sandbox.replace(disconnector.trainSkill, 'trainSkill', (command, args) => {
...
Error: There was an error while training the Dispatch model.`);
        });
        ...
        it("when the execution of a command fails", async function () {
            trainSkillStub.returns(Promise.reject(new Error('Mocked function throws an Error')));
            const config = {
                skillId : "testDispatch",
                skillsFile: path.resolve(__dirname, '../mockedFiles/filledSkillsArray.json'),
                outFolder : "",
