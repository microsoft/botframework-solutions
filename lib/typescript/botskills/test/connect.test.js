...
describe("The connect command", function () {
    ...
    beforeEach(function () {
        fs.writeFileSync(resolve(__dirname, join("mocks", "resources", "filledSkillsArray.json")), filledSkillsArray);
        fs.writeFileSync(resolve(__dirname, join("mocks", "resources", "successfulConnectFiles", "filledSkillsArray.json")), filledSkillsArray);
