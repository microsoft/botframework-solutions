...
using ChildWithDialogBot.CognitiveModels;
...
namespace ChildWithDialogBot.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> FinalStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            // End the dialog
            await stepContext.Context.SendActivityAsync(new Activity(ActivityTypes.EndOfConversation), cancellationToken);
