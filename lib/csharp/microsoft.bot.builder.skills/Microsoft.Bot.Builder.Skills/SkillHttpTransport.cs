...
namespace Microsoft.Bot.Builder.Skills
{
    public class SkillHttpTransport : ISkillTransport
    {
        ...
        public async Task<bool> ForwardToSkillAsync(ITurnContext dialogContext, Activity activity, Action<Activity> tokenRequestHandler = null, Action<Activity> apiResponseHandler = null)
        {
