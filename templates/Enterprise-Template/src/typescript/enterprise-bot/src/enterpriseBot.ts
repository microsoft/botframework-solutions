...
export class EnterpriseBot {
    ...
    constructor(botServices: BotServices, conversationState: ConversationState, userState: UserState) {
        ...
        this.DIALOGS = new DialogSet(this.CONVERSATION_STATE.createProperty<DialogState>('EnterpriseBot'));
        this.DIALOGS.add(new MainDialog(this.BOT_SERVICES, this.CONVERSATION_STATE, this.USER_STATE));
    }
