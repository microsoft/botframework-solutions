...
```shell
msbot clone services --name "EnterpriseBotSample" --luisAuthoringKey "YOUR_AUTHORING_KEY" --folder "DeploymentScripts\YOUR_LOCALE_FOLDER" --location "westus"
```
...
```shell
az bot publish --name "EnterpriseBotSample" --resource-group "EnterpriseBotSample"
```
