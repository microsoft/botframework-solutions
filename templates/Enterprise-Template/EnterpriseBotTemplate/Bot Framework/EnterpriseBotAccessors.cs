...
namespace $safeprojectname$
{
    ...
    {
        public $safeprojectname$Accessors(UserState userState, ConversationState conversationState)
        {
        ...
        public static string DialogStateName { get; } = $"{nameof($safeprojectname$Accessors)}.DialogState";
