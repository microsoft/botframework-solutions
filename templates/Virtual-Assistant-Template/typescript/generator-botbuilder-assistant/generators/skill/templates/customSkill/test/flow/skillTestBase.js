...
const {
    ...
    Locales,
    ResponseManager,
    SetLocaleMiddleware  } = require('botbuilder-solutions');
...
const MainResponses = require('../../lib/responses/main/mainResponses.js').MainResponses;
const SharedResponses = require('../../lib/responses/shared/sharedResponses.js').SharedResponses;
const SampleResponses = require('../../lib/responses/sample/sampleResponses.js').SampleResponses;
...
const getTestAdapter = function() {
    ...
    adapter.use(new SetLocaleMiddleware(cognitiveModelsRaw.defaultLocale || 'en-us'));
