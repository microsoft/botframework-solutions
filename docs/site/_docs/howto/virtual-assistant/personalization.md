...
![Virtual Assistant Introduction Card](\assets\images\virtualAssistant-introductionCard.png)
...
![Resource File Editor](\assets\images\virtualassistant-resourcefile.png)
...
![Skill Text Templating JSON Response File](\assets\images\virtualassistant-skilljsonresponses.png)
...
![Virtual Assistant Introduction Card](\assets\images\transcript-skillsdemo.png)