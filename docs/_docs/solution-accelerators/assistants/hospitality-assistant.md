...
1. Clone the [Hospitality Assistant Sample from our repository]({{site.repo}}/tree/master/samples/charp/assistants/hospitality-assistant).
...
1. Clone the following skills from our repository:
    ...
    - [Restaurant Booking Skill]({{site.repo}}/tree/master/skills/csharp/experimental/restaurantbooking)
...
1. [Add each skill]({{site.baseurl}}/skills/tutorials/create-skill/csharp/6-add-your-skill) using the botskills connect CLI tool. 

## Download transcripts

View sample conversations Hospitality Assistant solution by downloading a trancscript and opening with the [Bot Framework Emulator](https://aka.ms/botframework-emulator). For more flows of specific skills see [transcripts]({{site.baseurl}}/skills/samples/transcripts).
