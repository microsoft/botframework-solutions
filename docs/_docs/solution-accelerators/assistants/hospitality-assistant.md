...
1. Clone the [Hospitality Assistant sample]({{site.repo}}/tree/main/samples/csharp/assistants/hospitality-assistant).
...
1. Clone the following skills from our repository:
    - [Hospitality Skill](https://github.com/microsoft/botframework-skills/tree/main/skills/csharp/experimental/hospitalityskill)
    - [Point of Interest Skill](https://github.com/microsoft/botframework-skills/tree/main/skills/csharp/pointofinterestskill)
    - [Weather Skill](https://github.com/microsoft/botframework-skills/tree/main/skills/csharp/experimental/weatherskill)
    - [Bing Search Skill](https://github.com/microsoft/botframework-skills/tree/main/skills/csharp/experimental/bingsearchskill)
    - [News Skill](https://github.com/microsoft/botframework-skills/tree/main/skills/csharp/experimental/newsskill)
    - [Restaurant Booking Skill](https://github.com/microsoft/botframework-skills/tree/main/skills/csharp/experimental/restaurantbookingskill)
