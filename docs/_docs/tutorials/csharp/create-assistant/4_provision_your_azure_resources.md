...
You can find more detailed deployment steps including customization in the [Virtual Assistant and Skill Template deployment]({{site.baseurl}}/tutorials/csharp/create-assistant/csharp/4_provision_your_azure_resources) page.
