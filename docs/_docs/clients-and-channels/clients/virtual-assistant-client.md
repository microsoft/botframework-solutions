...
#### [Direct Line Speech configuration]({{site.repo}}/blob/main/samples/android/clients/VirtualAssistantClient/directlinespeech/src/main/assets/default_configuration.json)
{:.no_toc}
```json
{
...
#### [App configuration]({{site.repo}}/blob/main/samples/android/clients/VirtualAssistantClient/app/src/main/assets/default_app_configuration.json)
{:.no_toc}
```json
{
...
#### Optional: [Chat colors]({{site.repo}}/blob/main/samples/android/clients/VirtualAssistantClient/app/src/main/res/values/colors.xml)
{:.no_toc}
```xml
