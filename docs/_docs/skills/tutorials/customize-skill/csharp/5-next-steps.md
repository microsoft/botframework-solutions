...
<div class="card-deck">
    <a href="{{site.baseurl}}/skills/tutorials/add-action-support/csharp/1-intro/" class="card">
        <div class="card-body">
            <img src="{{site.baseurl}}/assets/images/icons/skill.png" alt="Speech icon" width="48px">
            <h4 class="card-title">Add action support</h4>
            <p class="card-text">Add action support to your Skill.</p>
        </div>
