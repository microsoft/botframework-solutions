...
Add any of the sample [Skills]({{site.repo}}/tree/main/skills) provided in the Bot Framework Solutions repository to your Virtual Assistant. The Skills are only available in C# at this time but these can be added to a TypeScript based assistant.