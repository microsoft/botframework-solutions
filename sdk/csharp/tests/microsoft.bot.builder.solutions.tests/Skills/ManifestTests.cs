...
using Microsoft.Bot.Builder.Solutions.Tests.Skills.Mocks;
...
namespace Microsoft.Bot.Builder.Solutions.Tests.Skills
{
    ...
    public class ManifestTests
    {
        ...
        {
            using (StreamReader sr = new StreamReader(@".\Skills\TestData\malformedManifestTemplate.json"))
            {
                var manifestBody = await sr.ReadToEndAsync();
                JsonConvert.DeserializeObject<SkillManifest>(manifestBody);
            }
        ...
        public async Task SkillControllerManifestRequest()
        {
            ...
            await controller.SkillManifestAsync(false);
        ...
        public async Task SkillControllerManifestRequestInlineTriggerUtterances()
        {
            ...
            await controller.SkillManifestAsync(true);
