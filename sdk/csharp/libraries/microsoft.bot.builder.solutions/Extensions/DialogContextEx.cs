...
namespace Microsoft.Bot.Builder.Solutions.Extensions
{
    ...
    {
        private const string SuppressDialogCompletionKey = "SupressDialogCompletionMessage";
        ...
        /// <param name="suppress">Boolean indicating whether any automatic dialog completion message shoudl be suppressed.</param>
        public static void ShouldSupressCompletionMessages(this DialogContext dc, bool suppress)
        {
            if (dc == null)
            {
        ...
        /// </summary>
        /// <param name="dc">DialogContext.</param>
        /// <returns>Indicates whether a dialog completion messagw should be sent.</param>
        public static bool ShouldSupressCompletionMessages(this DialogContext dc)
        {
            if (dc == null)
            {
                throw new ArgumentNullException(nameof(DialogContext));
